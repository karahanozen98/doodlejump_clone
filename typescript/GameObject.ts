...
export default class GameObject {
  ...
  constructor(width: number, height: number, posX: number, posY: number, color: string, collisions: boolean, gameWindow: typeOf_gameWindow) {
    this.width = width;
    this.height = height;
    this.color = color;
    this.posX = posX;
  ...
  // getters
  public getPos = (): type_Position => { return { x: [this.posX, this.posX + this.width], y: [this.posY, this.posY + this.height] } }
